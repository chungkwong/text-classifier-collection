...
public class TextDatasetHelper{
	 ...
	 * @return the samples stream
	 */
	public static Stream<Sample<String>> csvRecord(Path path,int dataField,int categoryField,boolean skipHeader,char separator,char quotationMark){
		try{
	 ...
	 * @return the samples stream
	 */
	public static Stream<Sample<String>> csvRecord(Path path,int dataField,int categoryField){
		try{
